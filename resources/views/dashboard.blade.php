                    ...
                    <div class="container px-5 py-24 mx-auto">
                        <div
                            ...
                            <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                                <h1 class="text-black text-2xl title-font font-bold mb-2">The Caffeine Code</h1>
                                ...
                                <div class="py-4">
                                    <div class=" inline-block mr-2">
                                        <div class="flex  pr-2 h-full items-center">
                                            ...
                                            <p class="title-font font-medium">Laravel</p>
                                        </div>
                                    </div>
                                    <div class="inline-block mr-2">
                                        <div class="flex  pr-2 h-full items-center">
                                            ...
                                            <p class="title-font font-medium">Vue Js</p>
                                        </div>
                                    </div>
                                    <div class=" inline-block mr-2">
                                        <div class="flex  pr-2 h-full items-center">
                                            ...
                                            <p class="title-font font-medium">React</p>
                                        </div>
                                    </div>
                                    <div class=" inline-block mr-2">
                                        <div class="flex  pr-2 h-full items-center">
